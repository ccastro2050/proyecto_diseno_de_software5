...
> el puerto 8060 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                         STATUS                    PORTS
> proyecto_diseno_de_software5-api-facturas-1   Up 2 hours                0.0.0.0:8060->8060/tcp
> proyecto_diseno_de_software5-postgres-1       Up 2 hours (healthy)      0.0.0.0:15456->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_diseno_de_software5.git
cd proyecto_diseno_de_software5
...
| Qué | Dónde |
|---|---|
| **API Facturas** — diagnóstico | http://localhost:8060/ |
| **Swagger** (documentación interactiva: ver y probar los endpoints) | http://localhost:8060/swagger |
| Listar productos | http://localhost:8060/api/producto |
| PostgreSQL (para SQLTools/pgAdmin, opcional) | `localhost:15456` · `postgres`/`Diseno123!` |
| SQL Server (opcional — v4) | `localhost,11456` · `sa`/`Diseno123!` |
| MariaDB (opcional — v5) | `localhost:13350` · `root`/`Diseno123!` |
...
> ℹ️ Este proyecto usa los puertos 8060 y 15456: si alguno ya está ocupado
...
│
├── api_facturas/                # LA API DE LA v1 — C#/ASP.NET Core (puerto 8060)
...
│   ├── appsettings.json         # Cadena de conexión (default localhost:15456)
