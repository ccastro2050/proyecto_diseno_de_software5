...
| v6 | **El front NACE** (Flask + Jinja2 + Bootstrap): la marca del MANUAL_DE_MARCA, login con sesión sobre verificar-contrasena, y el CRUD de producto desde el navegador | Sin especificar |
| v7 | El front COMPLETO: las 12 entidades con el patrón registro, llaves foráneas como select y el menú por roles | Sin especificar |
| v8 | La facturación en pantalla: crear maestro-detalle, anular con stock restaurado, estados con la marca | Sin especificar |
