...
Mapa de puertos: la familia de este curso termina en 42 (API 8060,
PostgreSQL 15456) — SQL Server toma **11456** (libre entre los 114xx ya
usados por otros cursos: 11463, 11563, 11432). La reconstrucción del
estudiante suma 100: **11556**.
