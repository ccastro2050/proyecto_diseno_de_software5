...
| `docker-compose.yml` | ★ servicio `mariadb` (11, :13350, se siembra solo) + `ConnectionStrings__MariaDb` |
...
- Puertos publicados: 8060 (API) · 15456 (postgres) · 11456 (sqlserver)
  · **13350 (mariadb)**. Reconstrucción del estudiante: +100 (13450).
