...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15456`.
...
| Port | `15456` | El puerto del host del compose (`15456:1433`) |
...
> El puerto es la clave: **15456, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15456
...
>
> ```
> Error opening connection Failed to connect to localhost:15456
...
> (`http://localhost:8060/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15456) con test y guardarla |
